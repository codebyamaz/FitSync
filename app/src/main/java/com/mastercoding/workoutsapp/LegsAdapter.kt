...
class LegsAdapter(private val context: Context, private val data: ArrayList<LegsData>) : RecyclerView.Adapter<LegsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LegsAdapter.ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.legs_layout, parent, false)
        return LegsAdapter.ViewHolder(view)
    }
